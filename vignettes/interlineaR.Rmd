...
read.lift() produce a list of three data frame: "entries", "senses", "examples" ("relations" should be added). All the fields of the dictionary, in all languages, can be extracted.
